...
function AppMeasurement_Module_ActivityMap(h) {
		...
		if (
			...
			c.a ||
				...
				((b = a.getAttribute('alt'))
					...
					? (c.t = b)
					: 'IMG' == ('' + a.nodeName).toUpperCase() && (b = a.getAttribute('src') || a.src) && (c.s = b)),
	...
	e.e = function() {
		e.trackScrollReach &&
			!v &&
			(e.scrollReachSelector ? r() : (q(), f.addEventListener && f.addEventListener('scroll', q, !1)), (v = !0));
	};
	e.link = function(a, d) {
		var c;
...
function AppMeasurement(r) {
		...
		if (a.lightProfileID) (d = a.O), (k = a.lightTrackVars) && (k = ',' + k + ',' + a.ka.join(',') + ',');
			...
			if (a.pe || a.linkType)
				(k = a.linkTrackVars),
					(f = a.linkTrackEvents),
					a.pe &&
						((e = a.pe.substring(0, 1).toUpperCase() + a.pe.substring(1)), a[e] && ((k = a[e].ac), (f = a[e].$b)));
			k && (k = ',' + k + ',' + a.F.join(',') + ',');
			f && k && (k += ',events,');
		}
		b && (b = ',' + b + ',');
		...
		if (a.lightProfileID) (b = a.O), (n = a.lightTrackVars) && (n = ',' + n + ',' + a.ka.join(',') + ',');
			...
			if (a.pe || a.linkType)
				(n = a.linkTrackVars),
					(m = a.linkTrackEvents),
					a.pe &&
						((e = a.pe.substring(0, 1).toUpperCase() + a.pe.substring(1)), a[e] && ((n = a[e].ac), (m = a[e].$b)));
			n && (n = ',' + n + ',' + a.F.join(',') + ',');
			m && ((m = ',' + m + ','), n && (n += ',events,'));
	...
	a.loadModule = function(c, b) {
		...
		if (!d) {
			...
			try {
				Object.defineProperty ? Object.defineProperty(d, 'onLoad', { get: d.ib, set: d.xb }) : (d._olc = 1);
			} catch (f) {
				d._olc = 1;
			}
		}
	...
	a.p = function() {
		var c;
		if (a.isReadyToTrack() && (a.yb(), a.j != q)) for (; 0 < a.j.length; ) (c = a.j.shift()), c.Db.apply(c.Eb, c.Bb);
	};
	a.yb = function() {
			  ...
			  a.b && a.b.attachEvent
					...
					: a.b &&
					  ...
					  (navigator &&
							...
							((a.Ga = 1), (a.useForcedLinkTracking = 1), a.b.addEventListener('click', a.r, !0)),
