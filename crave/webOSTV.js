			...
			i = function(e, n) {
				if (0 === Object.keys(o).length) {
					...
					i.onreadystatechange = function() {
						4 === i.readyState &&
							((i.status >= 200 && i.status < 300) || 0 === i.status ? r(null, i.responseText) : r({ status: 404 }));
					};
					try {
					...
					(r = [
						{
							...
							value: function(e) {
								...
								if (!window.PalmServiceBridge) {
									var p = { errorCode: -1, errorText: 'PalmServiceBridge is not found.', returnValue: !1 };
								...
								return (
									...
									(this.bridge.onservicecallback = this.callback.bind(this, c, f, w)),
									this.bridge.call(('/' !== (h = r).slice(-1) && (h += '/'), h + o), JSON.stringify(b)),
									this
								);
							}
						},
							...
							value: function() {
								...
								if (!this.cancelled) {
									...
									var i = o,
										s = i.errorCode,
										a = i.returnValue;
									s || !1 === a ? ((o.returnValue = !1), n(o)) : ((o.returnValue = !0), e(o)),
										r(o),
				...
				if (0 === Object.keys(V).length) {
					try {
						...
						(V.modelName = n.modelName),
							(V.version = n.platformVersion),
							(V.versionMajor = n.platformVersionMajor),
							(V.versionMinor = n.platformVersionMinor),
							(V.versionDot = n.platformVersionDot),
							(V.sdkVersion = n.platformVersion),
							(V.screenWidth = n.screenWidth),
							(V.screenHeight = n.screenHeight);
					} catch (e) {
						V.modelName = 'webOS Device';
					}
					(V.screenHeight = V.screenHeight || window.screen.height),
						(V.screenWidth = V.screenWidth || window.screen.width),
						O.tv &&
							(O.jcl
								? new m().send({
										...
										onSuccess: function(n) {
											if (
												((V.modelName = n.configs['tv.model.modelname'] || V.modelName),
												(V.sdkVersion = n.configs['tv.nyx.platformVersion'] || V.sdkVersion),
												(V.uhd = 'UD' === n.configs['tv.hw.panelResolution']),
												...
												for (
													var r = V.version.split('.'), t = ['versionMajor', 'versionMinor', 'versionDot'], o = 0;
													o < t.length;
													o += 1
												)
													try {
								...
								: new m().send({
										...
										onSuccess: function(n) {
											if (
												((V.modelName = n.modelName || V.modelName),
												(V.sdkVersion = n.sdkVersion || V.sdkVersion),
												(V.uhd = 'true' === n.UHD),
